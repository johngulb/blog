...
*/
add_action( 'init', 'gutenberg_examples_06_load_textdomain' );

function gutenberg_examples_06_load_textdomain() {
...
function gutenberg_examples_06_register_block() {
	...
	register_block_type( 'gutenberg-examples/example-06-mapped', array(
		'style' => 'gutenberg-examples-06',
